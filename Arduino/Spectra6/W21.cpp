...
// Optimized display function that works directly with BLE data (already in the correct format)
void PIC_display_fast(const unsigned char* picData, size_t dataLength)
{
  // The data is already in the correct format (packed 2 pixels per byte)
  EPD_W21_WriteCMD(0x10);
  
  // Write data directly to the display - no processing needed
